		...
		function meup_content_readmore( ) { ?>
			<div class="post-footer">
				<div class="post-readmore-meup">
					<a class="btn btn-theme btn-theme-transparent second_font" href="<?php the_permalink(); ?>"><?php  esc_html_e('Read More', 'meup'); ?></a>
				</div>
			</div>
		<?php }
	}
...
if ( ! function_exists( 'meup_theme_comment' ) ) {
	function meup_theme_comment($comment, $args, $depth) {
		...
		<li <?php comment_class(); ?> id="li-comment-<?php echo $comment_id; ?>">
			<article class="comment_item" id="comment-<?php echo $comment_id; ?>">
				...
				<header class="comment-author">
					...
					<?php
						...
						if( $img_path ){ ?>
							...
							<img src="<?php echo esc_attr( $link_url ) ?>" alt="<?php printf('%s', get_comment_author_link()) ?>">
