	...
	class El_Admin_Ajax{
				...
				<table class="form-table">
					<tbody>
						<tr>
							...
							<td>
								<input name="<?php echo OVA_METABOX_EVENT.'extra_service['.$k.'][name]'; ?>" type="text" value="" placeholder="<?php esc_attr_e( 'Enter Name', 'eventlist' ); ?>" required class="extra_service_name regular-text">
								<input name="<?php echo OVA_METABOX_EVENT.'extra_service['.$k.'][id]'; ?>" type="hidden" class="extra_service_id" value="">
							</td>
						</tr>
						<tr>
							<th scope="row"><label for=""><?php esc_html_e( 'Price', 'eventlist' ); ?></label></th>
							<td><input name="<?php echo OVA_METABOX_EVENT.'extra_service['.$k.'][price]'; ?>" type="number" min="0" step="0.1" value="" placeholder="<?php echo esc_attr_e( '10', 'eventlist' ); ?>" class="extra_service_price regular-number"></td>
						</tr>
						<tr>
							<th scope="row"><label for=""><?php esc_html_e( 'Max Quantity/Calendar', 'eventlist' ); ?></label></th>
							<td><input name="<?php echo OVA_METABOX_EVENT.'extra_service['.$k.'][qty]'; ?>" type="number" min="0" step="1" value="" placeholder="<?php esc_attr_e( '100', 'eventlist' ); ?>" required class="extra_service_qty regular-number"></td>
						</tr>
						<tr>
							<th scope="row"><label for=""><?php esc_html_e( 'Max Quantity/Ticket', 'eventlist' ); ?></label></th>
							<td><input name="<?php echo OVA_METABOX_EVENT.'extra_service['.$k.'][max_qty]'; ?>" type="number" min="0" step="1" value="" placeholder="<?php esc_attr_e( '10', 'eventlist' ); ?>" class="extra_service_max_qty regular-number"></td>
						</tr>
					</tbody>
				</table>
		...
		public static function add_area_map(){
			...
			<div class="item_area" data-prefix="<?php echo esc_attr( $_prefix ); ?>">
				...
				<input type="hidden" class="person_price" name="<?php echo esc_attr( $_prefix.'ticket_map[area]['.((int) $key - 1).'][person_price]' ); ?>" value="">
