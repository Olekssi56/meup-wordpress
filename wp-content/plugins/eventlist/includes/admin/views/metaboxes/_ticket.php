								...
								<div class="content_ticket">
									...
									<div class="bottom_ticket">
										...
										<div class="private_desc_ticket">
											...
											<textarea name="<?php echo esc_attr( $this->get_mb_name( 'ticket['.$key.'][private_desc_ticket]' ) ); ?>" id="private_desc_ticket" cols="30" rows="5"><?php echo isset( $value['private_desc_ticket'] ) ? $value['private_desc_ticket'] : ''; ?></textarea>
										</div>
									...
									<div class="wrap_seat_list" style="<?php if ( $this->get_mb_value( 'seat_option' ) == 'simple' ) echo esc_attr('display: flex;'); ?>">
										<label class="label" for="seat_list">
