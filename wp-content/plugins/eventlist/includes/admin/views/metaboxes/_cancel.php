...
<div class="edit_event_cancel_booking">
	...
	<input type="radio" value="yes" name="<?php echo $this->get_mb_name( 'allow_cancellation_booking' ); ?>" <?php if ( $allow_cancellation_booking == 'yes' ) echo esc_attr('checked') ; ?> />
	<span><?php esc_html_e( 'Yes', 'eventlist' ); ?></span>

	
	<input type="radio" value="no" name="<?php echo $this->get_mb_name( 'allow_cancellation_booking' );?>" <?php if ( $allow_cancellation_booking == 'no') echo esc_attr('checked') ; ?> />
...
<div class="cancel_bk_before_x_day">
	...
	<input type="text" name="<?php echo $this->get_mb_name( 'cancel_before_x_day' ); ?>" value="<?php echo esc_attr( $cancel_before_x_day ); ?>" >
</div>