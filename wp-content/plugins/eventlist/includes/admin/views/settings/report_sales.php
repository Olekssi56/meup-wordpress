		...
		<div class="accounting">
			<ul class="filter">
				<li class="<?php echo ( 'year' === $current_range ) ? 'active' : ''; ?>">
					<a href="<?php echo add_query_arg( array( 'post_type' => 'event', 'page' => 'ova_el_display_report_sales', 'range' => 'year' ), get_admin_url('', 'edit.php') ); ?>">
						<?php esc_html_e( 'Year', 'eventlist' ); ?>
					</a>
				</li>

				<li class="<?php echo ( 'last_month' === $current_range ) ? 'active' : ''; ?>">
					<a href="<?php echo add_query_arg( array( 'post_type' => 'event', 'page' => 'ova_el_display_report_sales', 'range' => 'last_month' ), get_admin_url('', 'edit.php') ); ?>">
						<?php esc_html_e( 'Last Month', 'eventlist' ); ?>
					</a>
				</li>

				<li class="<?php echo ( 'month' === $current_range ) ? 'active' : ''; ?>">
					<a href="<?php echo add_query_arg( array( 'post_type' => 'event', 'page' => 'ova_el_display_report_sales', 'range' => 'month' ), get_admin_url('', 'edit.php') ); ?>">
						<?php esc_html_e( 'This Month', 'eventlist' ); ?>
					</a>
				</li>

				<li class="<?php echo ( '7_day' === $current_range ) ? 'active' : ''; ?>">
					<a href="<?php echo add_query_arg( array( 'post_type' => 'event', 'page' => 'ova_el_display_report_sales', 'range' => '7_day' ), get_admin_url('', 'edit.php') ); ?>">
